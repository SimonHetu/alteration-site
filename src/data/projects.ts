export const projects = [
  ...
  },
  {
    ...
    thumbnail: new URL("../assets/images/development/kernel-coffee/kernel-coffee-01-50.jpg", import.meta.url).href,
    website: {
  ...
  },
  {
    ...
    thumbnail: new URL("../assets/images/development/crime-vision/crime-vision-01-50.jpg", import.meta.url).href,
    website: {
  ...
  },
  {
    ...
    category: "Application Development",
    role: "Full-stack Development",
    tools: ["Project tracking", "Workflow management", "Responsive UI"],
    images: [
      new URL("../assets/images/development/trackflow/trackflow-01.jpg", import.meta.url).href,
      new URL("../assets/images/development/trackflow/trackflow-02.jpg", import.meta.url).href,
      new URL("../assets/images/development/trackflow/trackflow-03.jpg", import.meta.url).href,
      new URL("../assets/images/development/trackflow/trackflow-04.jpg", import.meta.url).href,
      new URL("../assets/images/development/trackflow/trackflow-05.jpg", import.meta.url).href,
      new URL("../assets/images/development/trackflow/trackflow-06.jpg", import.meta.url).href,
